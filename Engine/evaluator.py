...
from Engine.input_reader import JsonInputReader
from Engine.opt import jinja2
...
class Evaluator:
    ...
    def eval_batch(self, AE_clf, OE_clf, AOE_clf, AOPE_clf, ALSC_clf, AESC_clf, TE_clf, batch: dict):
